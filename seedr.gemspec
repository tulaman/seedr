...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG", "Rakefile", "bin/seedr", "Manifest", "lib/multipart_post_request.rb", "lib/seedr/cli.rb", "lib/seedr/ext.rb", "lib/seedr/video.rb", "lib/seedr/bot.rb", "lib/seedr/version.rb", "lib/seedr/sites/rutube_ru.rb", "lib/seedr/sites/youtube_com.rb", "lib/seedr/sites/yandex_ru.rb", "lib/seedr/sites/smotri_com.rb", "lib/seedr.rb", "test/seedr_test.rb", "License", "README.rdoc", "seedr.gemspec"]
  s.has_rdoc = true
  s.homepage = %q{}
